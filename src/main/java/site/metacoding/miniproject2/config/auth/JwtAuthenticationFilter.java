...
public class JwtAuthenticationFilter implements Filter {
    ...
    private final Logger logger = LoggerFactory.getLogger("JwtAuthenticationFilter 로그");
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        logger.debug("디버그 : " + loginReqDto.getUserId());
        logger.debug("디버그 : " + loginReqDto.getUserPassword());
